...
Функция ИнформацияДляПоддержки() 
	...
	UT_CommonServerCall.ДополнитьИнформациюДляПоддержкиНаСервере(СтруктураИнформации);
...
Функция КаталогВспомогательныхБиблиотекИнструментов() Экспорт
	...
	Возврат UT_CommonClientServer.КаталогВспомогательныхБиблиотекИнструментов(
