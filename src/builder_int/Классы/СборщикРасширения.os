...
Процедура ВыполнитьСборкуИсходников() Экспорт
	...
	Если ЗначениеЗаполнено(ВариантСборки.СуффиксСинонима) Тогда
		Синонимы = СвойстваКонфигурацииОсновногоРасширения["Synonym"];
		Если ТипЗнч(Синонимы) = Тип("Соответствие") Тогда
		...
		КонецЕсли;
		Если ТипЗнч(Синонимы) = Тип("Массив") Тогда
			Для Каждого ТекСиноним ИЗ Синонимы Цикл
				ТекСиноним["v8:item"]["v8:content"] = ТекСиноним["v8:item"]["v8:content"] + " " + ВариантСборки.СуффиксСинонима;
			КонецЦикла;
		КонецЕсли;	
	КонецЕсли;
