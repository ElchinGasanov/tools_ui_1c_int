...
Процедура ПосетитьВыражениеЛитерал(Описание) Экспорт
	...
	Если ОткрытиеОбщейФормы Тогда
		МассивИмени.Вставить(0,"ExternalDataProcessor.UT_PortableUniversalTools.Form");
	ИначеЕсли ОткрытиеФормыОтчета Тогда
		МассивИмени.Вставить(0,"ExternalReport");
	Иначе
		МассивИмени.Вставить(0,"ExternalDataProcessor");
	КонецЕсли;
