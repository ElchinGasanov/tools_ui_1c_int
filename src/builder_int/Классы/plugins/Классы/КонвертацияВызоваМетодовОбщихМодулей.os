...
Процедура ПосетитьВыражениеИдентификатор(ВыражениеИдентификатор) Экспорт
	...
	Если ЭтоМодульФормы 
		...
		Если ДоступенКонтекстФормы Тогда
			ТекстЗамены=ПрефиксПеременныхИПроцедур+"CommonModulesByName("""+Объявление+""", "+ПрефиксПеременныхИПроцедур+"CommonModuleCache, ThisForm)";
		Иначе
			ТекстЗамены=ПрефиксПеременныхИПроцедур+"CommonModulesByName("""+Объявление+""", "+ПрефиксПеременныхИПроцедур+"CommonModuleCache)";
		КонецЕсли;
	Иначе
		ТекстЗамены=ПрефиксПеременныхИПроцедур+"CommonModulesByName("""+Объявление+""")";
	КонецЕсли;
